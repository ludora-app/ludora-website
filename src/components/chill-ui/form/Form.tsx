...
import { cn, Input, Label, Textarea } from '@chillUi';
      ...
      <FormControl>
        {textArea ? (
          <Textarea
            ...
            className={cn(className, !resizable && 'resize-none')}
            {...(props as React.ComponentProps<typeof Textarea>)}
          />
        ) : (
          <Input placeholder={placeholder} className={className} {...(props as React.ComponentProps<typeof Input>)} />
        )}
      </FormControl>
      {showError && (
